CREATE DATABASE  IF NOT EXISTS `tracker25` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tracker25`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: tracker25
-- ------------------------------------------------------
...
CREATE TABLE `location` (
  ...
  PRIMARY KEY (`id`),
  INDEX `idx_location_userid` (`userid`)
...
CREATE TABLE `user` (
  ...
  `sex` varchar(12) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT 'thing',
...
-- Dump completed on 2025-01-20 11:05:38